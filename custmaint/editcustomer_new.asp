						...
						<div id="orderlinenotes">
							<form id="formCustomer" name="formCustomer" method="post" action="<%=Session("SaveURL")%>">
								...
								<div class="row">
									...
									<div class="col width-25">
										<label>Email</label>
										<input type="text" name="saveemail" value="<%=gsEMail%>" />
									</div>
									<div class="col width-25">
								...
								<div class="row" id="extraEdit">
									...
									<div class="col width-25">
										...
										<div class="toggleButton<%=Iif(gbIsEmailList," active", "")%>" data-on="yes" data-off="no"></div>
									...
									<div class="col width-25">
										<label>Text Me?</label>
										<div class="toggleButton<%=Iif(gbIsTextList," active", "")%>" data-on="yes" data-off="no"></div>
