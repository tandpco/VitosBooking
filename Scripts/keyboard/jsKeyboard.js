var jsKeyboard = {
    ...
    generateKeyboard: function (keyboard) {
        ...
        s += "<div onclick=\"jsKeyboard.hide();\" id='hideButton'><span>" + jsKeyboard.settings.text.close + "</span></div>"
        s += "<div onclick=\"jsKeyboard.show();\" id='showButton'><span>" + jsKeyboard.settings.text.show + "</span></div>"
        s += "</div>";
    ...
    write: function (m) {
        ...
        jsKeyboard.currentElement.trigger('change')
    ...
    hide: function () {
        ...
        $("#keyboard #showButton").show();
        $("#keyboard").animate({ "height": "40px" }, "slow", function () { });
    },
    defaultKeyboard: {
        capitalLetter:
            [
