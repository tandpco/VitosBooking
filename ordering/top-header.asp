...
<tr height="72">
  <td valign="top" width="1010" height="72">
    ...
    <ol id="tabs">
      ...
      <li class="<%=IIf(currentTab = "phone","active","")%>"><a onclick="if(confirm('Are you sure? You will lose any data you have entered so far.')) window.location = '/ordering/neworder.asp'" title="Phone">Phone</a></li>
      ...
      <li class="<%=IIf(currentTab = "address"," active","")%>">
        ...
        <% Else %>
          <a href="/ordering/customerfind.php?t=<%=Session("OrderTypeID")%>">Address</a>
        <% End If %>
      </li>
